...
ax = predictions_df_.rename(columns={"Prices": "predicted_price"}).plot(title='MCD KNN predicted prices')#predicted value
ax.set_xlabel("Indexes")
ax.set_ylabel("Stock Prices")
fig = y_test.rename(columns={"Prices": "actual_price"}).plot(ax = ax).get_figure()#actual value
fig.savefig(r"C:\Users\may\Desktop\FYP_VS\MCD\MCD_KNN.png")
...
# Save
import gzip
with gzip.GzipFile(r'C:\Users\may\Desktop\FYP_VS\MCD\MCD_KNN_model.pgz', 'w') as f:
    pickle.dump(knn,f)
print("Model saved!")
