...
ax = predictions_df_.rename(columns={"Prices": "predicted_price"}).plot(title=company_name+' Random Forest predicted prices')#predicted value
ax.set_xlabel("Indexes")
ax.set_ylabel("Stock Prices")
fig = y_test.rename(columns={"Prices": "actual_price"}).plot(ax = ax).get_figure()#actual value
fig.savefig(company+"_Random_Forest.png")
