...
ax = predictions_df_.rename(columns={"Prices": "Predicted"}).plot(title=company_name+' Linear Regression predicted prices')
ax.set_xlabel("Indexes")
ax.set_ylabel("Stock Prices")
fig = y_test.rename(columns={"Prices": "actual"}).plot(ax = ax).get_figure()#actual value
